export default function HomePage() {
  return (
    <div className="page">
      ...
      <section>
        <h2>Training</h2>
        <p>I followed an intensive web development training program with <a href="https://www.wf3.fr/">WebForce3 Strasbourg</a> from October 2020 to October 2021 which I graduated from.</p>
      </section>
    </div>
  );
}
